...
# reason: 0: not relaxed enough, 1: not contracted enough, 2: both
def assign_to_provenance(value_assignment, numeric_attributes, categorical_attributes, selection_numeric,
    ...
    survive1 = assign_to_provenance_relax_only(value_assignment, numeric_attributes, categorical_attributes,
                                              selection_numeric, selection_categorical, columns_delta_table,
                                              fairness_constraints_provenance_greater_than)
    # if not survive:
    #     # print("not relaxed enough")
    #     return False, 0
    survive2 = assign_to_provenance_contract_only(value_assignment, numeric_attributes, categorical_attributes,
                                                 selection_numeric, selection_categorical, columns_delta_table,
                                                 fairness_constraints_provenance_smaller_than)
    # if not survive:
    #     print("relaxed enough but not contracted enough")
    if survive1 and survive2:
        return True, 2
    elif not survive1 and not survive2:
        return False, 2
    elif survive1:
        return False, 0
    elif survive2:
    ...
    while PVT_stack:
        ...
        while att_idx < num_columns and att_idx >= 0:
            ...
            if att_idx == num_columns - 1 and col in numeric_attributes:  # last column
                ...
                if originalreason == 2:  # not relaxed enough and not contracted enough
                    new_value_assignment_position[att_idx] = -1
