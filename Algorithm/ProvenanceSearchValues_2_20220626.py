...
def searchPVT(PVT, PVT_head, categorical_att_columns, numeric_attributes, categorical_attributes,
              selection_numeric, selection_categorical, num_columns, fairness_constraints_provenance_greater_than,
              fixed_value_assignments, full_PVT, full_PVT_head, minimal_refinements, max_index_PVT,
    ...
    # optimization:
    # when move up and fix a value, make sure there are other columns that can be moved down
    def recursion(column):
        ...
        while idx_in_this_col > 0:
            ...
            found_relaxation = searchPVT(PVT_for_recursion, new_PVT_head,
                                         ...
                                         fairness_constraints_provenance_greater_than,
                                         fixed_value_assignments, full_PVT, full_PVT_head, minimal_refinements,
                                         new_max_index_PVT,
                                         checked_assignments_satisfying, checked_assignments_not_satisfying)
            fixed_value_assignments.pop(PVT_head[col_idx])
