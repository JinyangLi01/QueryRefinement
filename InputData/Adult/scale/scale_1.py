...
time_output.write("data size,PS,LT\n")
...
for i in range(1, 7):
    ...
    data_file = r"adult_" + str(2**(i-1)) + "k.csv"

    print("========================== provenance search ===================================")
    minimal_refinements1, running_time1, assign_to_provenance_num,\
        provenance_time, table_time, search_time = \
        ps.FindMinimalRefinement(data_file, query_file, constraint_file, time_limit)

    print("running time = {}".format(running_time1), provenance_time, table_time, search_time)
    ...
    time_output.write("{},{:0.2f},{:0.2f},{:0.2f},{:0.2f}\n".format(2**(i-1), running_time1, provenance_time, table_time, search_time))
    result_output.write("{}\n".format(2**(i-1)))
