...
def compare(q, c, time_output):
    ...
    minimal_refinements1, running_time1, _, \
        ...
        ps.FindMinimalRefinement(data_file_prefix, query_file, constraint_file, time_limit)
    ...
    minimal_refinements2, minimal_added_refinements2, running_time2, provenance_time2, search_time2 = \
        lt.FindMinimalRefinement(data_file_prefix, query_file, constraint_file, time_limit)
