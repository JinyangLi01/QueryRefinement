...
def run(query, size, constraint):
    ...
    plt.xlabel(r'o\underline{ }orderdate, 2m apart', fontsize=80, weight='bold')
    # plt.ylabel('Running time (s)')
    plt.legend(loc='upper right', bbox_to_anchor=(1.04, 0.48), fontsize=58)
