...
plt.xticks(np.arange(0, 4) + bar_width/2, x_list, rotation=0, fontsize=48)
plt.yticks(fontsize=80, weight='bold')

plt.xlabel('Query and Constraint', fontsize=80, weight='bold')

plt.yscale('log')
lgnd = plt.legend(loc='upper center', bbox_to_anchor=(0.48, 1.45), fontsize=44, ncol=2, labelspacing=0.4,
