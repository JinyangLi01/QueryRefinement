...
data_size = ["200", "400", "600", "800"]

for i in range(1, 5):
    query_file = r"../../../InputData/Healthcare/incomeK/scale_3/query" + str(i) + ".json"
    constraint_file = r"../../../InputData/Healthcare/incomeK/scale_3/constraint" + str(i) + ".json"
    data_file = "../../../InputData/Healthcare/incomeK/scale_3/healthcare_" + data_size[i-1] + ".csv"
