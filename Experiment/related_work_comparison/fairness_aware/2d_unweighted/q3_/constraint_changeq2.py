...
def run_constraint(q):
    ...
    time_output_file = r"./constraint_change_q" + str(q) + "_withrotation.csv"
    ...
    for i in range(1, 8):
        ...
        print("running time = {}, num refinements = {}, time per refinement = {}".format(running_time1,
        ...
        result_output.write("\n")
        idx = i
        time_output.write("{},{},{:0.5f}\n".format(idx, len(minimal_refinements1), running_time1 / len(minimal_refinements1)))
        result_output.write("{}\n".format(idx))
